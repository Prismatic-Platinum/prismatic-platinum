...
//Platinum Trainers
extern const u32 gTrainerFrontPic_DP_Ace_Trainer_DoubleTeam[];
extern const u32 gTrainerFrontPic_DP_Ace_Trainer_F[];
extern const u32 gTrainerFrontPic_DP_Ace_Trainer_M[];
extern const u32 gTrainerFrontPic_DP_Ace_Trainer_Snow_F[];
extern const u32 gTrainerFrontPic_DP_Ace_Trainer_Snow_M[];
extern const u32 gTrainerFrontPic_DP_Aroma_Lady[];
extern const u32 gTrainerFrontPic_DP_Barry[];
extern const u32 gTrainerFrontPic_DP_Battle_Girl[];
extern const u32 gTrainerFrontPic_DP_Beauty[];
extern const u32 gTrainerFrontPic_DP_Bertha[];
extern const u32 gTrainerFrontPic_DP_Bird_Keeper[];
extern const u32 gTrainerFrontPic_DP_Black_Belt[];
extern const u32 gTrainerFrontPic_DP_Breeder_F[];
extern const u32 gTrainerFrontPic_DP_Breeder_M[];
extern const u32 gTrainerFrontPic_DP_Buck[];
extern const u32 gTrainerFrontPic_DP_Bug_Catcher[];
extern const u32 gTrainerFrontPic_DP_Byron[];
extern const u32 gTrainerFrontPic_DP_Cameraman[];
extern const u32 gTrainerFrontPic_DP_Camper[];
extern const u32 gTrainerFrontPic_DP_Candice[];
extern const u32 gTrainerFrontPic_DP_Cheryl[];
extern const u32 gTrainerFrontPic_DP_Clown[];
extern const u32 gTrainerFrontPic_DP_Collector[];
extern const u32 gTrainerFrontPic_DP_Cowgirl[];
extern const u32 gTrainerFrontPic_DP_Crasher_Wake[];
extern const u32 gTrainerFrontPic_DP_Cyclist_F[];
extern const u32 gTrainerFrontPic_DP_Cyclist_M[];
extern const u32 gTrainerFrontPic_DP_Cynthia[];
extern const u32 gTrainerFrontPic_DP_Cyrus[];
extern const u32 gTrainerFrontPic_DP_Dragon_Tamer[];
extern const u32 gTrainerFrontPic_DP_Fantina[];
extern const u32 gTrainerFrontPic_DP_Fisherman[];
extern const u32 gTrainerFrontPic_DP_Galactic_Grunt_F[];
extern const u32 gTrainerFrontPic_DP_Galactic_Grunt_M[];
extern const u32 gTrainerFrontPic_DP_Gambler[];
extern const u32 gTrainerFrontPic_DP_Gardenia[];
extern const u32 gTrainerFrontPic_DP_Gentleman[];
extern const u32 gTrainerFrontPic_DP_Hiker[];
extern const u32 gTrainerFrontPic_DP_Idol[];
extern const u32 gTrainerFrontPic_DP_Interviewers[];
extern const u32 gTrainerFrontPic_DP_Jogger[];
extern const u32 gTrainerFrontPic_DP_Jupiter[];
extern const u32 gTrainerFrontPic_DP_Lady[];
extern const u32 gTrainerFrontPic_DP_Lass[];
extern const u32 gTrainerFrontPic_DP_Lucian[];
extern const u32 gTrainerFrontPic_DP_Marley[];
extern const u32 gTrainerFrontPic_DP_Mars[];
extern const u32 gTrainerFrontPic_DP_Maylene[];
extern const u32 gTrainerFrontPic_DP_Mira[];
extern const u32 gTrainerFrontPic_DP_Ninja_Boy[];
extern const u32 gTrainerFrontPic_DP_Officer[];
extern const u32 gTrainerFrontPic_DP_Painter_Artist[];
extern const u32 gTrainerFrontPic_DP_Palmer[];
extern const u32 gTrainerFrontPic_DP_Parasol_Lady[];
extern const u32 gTrainerFrontPic_DP_Picnicker[];
extern const u32 gTrainerFrontPic_DP_Poke_Kid[];
extern const u32 gTrainerFrontPic_DP_Pokefan_F[];
extern const u32 gTrainerFrontPic_DP_Pokefan_M[];
extern const u32 gTrainerFrontPic_DP_Pokemon_Ranger_F[];
extern const u32 gTrainerFrontPic_DP_Pokemon_Ranger_M[];
extern const u32 gTrainerFrontPic_DP_Psychic_F[];
extern const u32 gTrainerFrontPic_DP_Psychic_M[];
extern const u32 gTrainerFrontPic_DP_Rancher[];
extern const u32 gTrainerFrontPic_DP_Rancher_Duo_Belle_and_Pa[];
extern const u32 gTrainerFrontPic_DP_Reporter[];
extern const u32 gTrainerFrontPic_DP_Rich_Boy[];
extern const u32 gTrainerFrontPic_DP_Riley[];
extern const u32 gTrainerFrontPic_DP_Roark[];
extern const u32 gTrainerFrontPic_DP_Rocker_Guitarist[];
extern const u32 gTrainerFrontPic_DP_Roughneck[];
extern const u32 gTrainerFrontPic_DP_Ruin_Maniac[];
extern const u32 gTrainerFrontPic_DP_Sailor[];
extern const u32 gTrainerFrontPic_DP_Saturn[];
extern const u32 gTrainerFrontPic_DP_School_Kid_F[];
extern const u32 gTrainerFrontPic_DP_School_Kid_M[];
extern const u32 gTrainerFrontPic_DP_Scientist[];
extern const u32 gTrainerFrontPic_DP_Skier_F[];
extern const u32 gTrainerFrontPic_DP_Skier_M[];
extern const u32 gTrainerFrontPic_DP_Socialite[];
extern const u32 gTrainerFrontPic_DP_Swimmer_F[];
extern const u32 gTrainerFrontPic_DP_Swimmer_M[];
extern const u32 gTrainerFrontPic_DP_Tuber_F[];
extern const u32 gTrainerFrontPic_DP_Tuber_M[];
extern const u32 gTrainerFrontPic_DP_Twins[];
extern const u32 gTrainerFrontPic_DP_Veteran[];
extern const u32 gTrainerFrontPic_DP_Volkner[];
extern const u32 gTrainerFrontPic_DP_Waiter[];
extern const u32 gTrainerFrontPic_DP_Waitress[];
...
//Platinum Trainers
extern const u32 gTrainerPalette_DP_Ace_Trainer_DoubleTeam[];
extern const u32 gTrainerPalette_DP_Ace_Trainer_F[];
extern const u32 gTrainerPalette_DP_Ace_Trainer_M[];
extern const u32 gTrainerPalette_DP_Ace_Trainer_Snow_F[];
extern const u32 gTrainerPalette_DP_Ace_Trainer_Snow_M[];
extern const u32 gTrainerPalette_DP_Aroma_Lady[];
extern const u32 gTrainerPalette_DP_Barry[];
extern const u32 gTrainerPalette_DP_Battle_Girl[];
extern const u32 gTrainerPalette_DP_Beauty[];
extern const u32 gTrainerPalette_DP_Bertha[];
extern const u32 gTrainerPalette_DP_Bird_Keeper[];
extern const u32 gTrainerPalette_DP_Black_Belt[];
extern const u32 gTrainerPalette_DP_Breeder_F[];
extern const u32 gTrainerPalette_DP_Breeder_M[];
extern const u32 gTrainerPalette_DP_Buck[];
extern const u32 gTrainerPalette_DP_Bug_Catcher[];
extern const u32 gTrainerPalette_DP_Byron[];
extern const u32 gTrainerPalette_DP_Cameraman[];
extern const u32 gTrainerPalette_DP_Camper[];
extern const u32 gTrainerPalette_DP_Candice[];
extern const u32 gTrainerPalette_DP_Cheryl[];
extern const u32 gTrainerPalette_DP_Clown[];
extern const u32 gTrainerPalette_DP_Collector[];
extern const u32 gTrainerPalette_DP_Cowgirl[];
extern const u32 gTrainerPalette_DP_Crasher_Wake[];
extern const u32 gTrainerPalette_DP_Cyclist_F[];
extern const u32 gTrainerPalette_DP_Cyclist_M[];
extern const u32 gTrainerPalette_DP_Cynthia[];
extern const u32 gTrainerPalette_DP_Cyrus[];
extern const u32 gTrainerPalette_DP_Dragon_Tamer[];
extern const u32 gTrainerPalette_DP_Fantina[];
extern const u32 gTrainerPalette_DP_Fisherman[];
extern const u32 gTrainerPalette_DP_Galactic_Grunt_F[];
extern const u32 gTrainerPalette_DP_Galactic_Grunt_M[];
extern const u32 gTrainerPalette_DP_Gambler[];
extern const u32 gTrainerPalette_DP_Gardenia[];
extern const u32 gTrainerPalette_DP_Gentleman[];
extern const u32 gTrainerPalette_DP_Hiker[];
extern const u32 gTrainerPalette_DP_Idol[];
extern const u32 gTrainerPalette_DP_Interviewers[];
extern const u32 gTrainerPalette_DP_Jogger[];
extern const u32 gTrainerPalette_DP_Jupiter[];
extern const u32 gTrainerPalette_DP_Lady[];
extern const u32 gTrainerPalette_DP_Lass[];
extern const u32 gTrainerPalette_DP_Lucian[];
extern const u32 gTrainerPalette_DP_Marley[];
extern const u32 gTrainerPalette_DP_Mars[];
extern const u32 gTrainerPalette_DP_Maylene[];
extern const u32 gTrainerPalette_DP_Mira[];
extern const u32 gTrainerPalette_DP_Ninja_Boy[];
extern const u32 gTrainerPalette_DP_Officer[];
extern const u32 gTrainerPalette_DP_Painter_Artist[];
extern const u32 gTrainerPalette_DP_Palmer[];
extern const u32 gTrainerPalette_DP_Parasol_Lady[];
extern const u32 gTrainerPalette_DP_Picnicker[];
extern const u32 gTrainerPalette_DP_Poke_Kid[];
extern const u32 gTrainerPalette_DP_Pokefan_F[];
extern const u32 gTrainerPalette_DP_Pokefan_M[];
extern const u32 gTrainerPalette_DP_Pokemon_Ranger_F[];
extern const u32 gTrainerPalette_DP_Pokemon_Ranger_M[];
extern const u32 gTrainerPalette_DP_Psychic_F[];
extern const u32 gTrainerPalette_DP_Psychic_M[];
extern const u32 gTrainerPalette_DP_Rancher[];
extern const u32 gTrainerPalette_DP_Rancher_Duo_Belle_and_Pa[];
extern const u32 gTrainerPalette_DP_Reporter[];
extern const u32 gTrainerPalette_DP_Rich_Boy[];
extern const u32 gTrainerPalette_DP_Riley[];
extern const u32 gTrainerPalette_DP_Roark[];
extern const u32 gTrainerPalette_DP_Rocker_Guitarist[];
extern const u32 gTrainerPalette_DP_Roughneck[];
extern const u32 gTrainerPalette_DP_Ruin_Maniac[];
extern const u32 gTrainerPalette_DP_Sailor[];
extern const u32 gTrainerPalette_DP_Saturn[];
extern const u32 gTrainerPalette_DP_School_Kid_F[];
extern const u32 gTrainerPalette_DP_School_Kid_M[];
extern const u32 gTrainerPalette_DP_Scientist[];
extern const u32 gTrainerPalette_DP_Skier_F[];
extern const u32 gTrainerPalette_DP_Skier_M[];
extern const u32 gTrainerPalette_DP_Socialite[];
extern const u32 gTrainerPalette_DP_Swimmer_F[];
extern const u32 gTrainerPalette_DP_Swimmer_M[];
extern const u32 gTrainerPalette_DP_Tuber_F[];
extern const u32 gTrainerPalette_DP_Tuber_M[];
extern const u32 gTrainerPalette_DP_Twins[];
extern const u32 gTrainerPalette_DP_Veteran[];
extern const u32 gTrainerPalette_DP_Volkner[];
extern const u32 gTrainerPalette_DP_Waiter[];
extern const u32 gTrainerPalette_DP_Waitress[];
