...
const u16 gMetatiles_JubilifeCity[] = INCBIN_U16("data/tilesets/primary/jubilife_city/metatiles.bin");
const u16 gMetatileAttributes_JubilifeCity[] = INCBIN_U16("data/tilesets/primary/jubilife_city/metatile_attributes.bin");
