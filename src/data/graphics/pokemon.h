...
const u8 gMonFootprint_QuestionMark[] = INCBIN_U8("graphics/pokemon/question_mark/footprint.1bpp");
    ...
    const u32 gMonFrontPic_Darkrai_D[] = INCBIN_U32("graphics/pokemon/darkrai/distortion/anim_front.4bpp.lz");
    const u32 gMonPalette_Darkrai_D[] = INCBIN_U32("graphics/pokemon/darkrai/distortion/normal.gbapal.lz");
    const u32 gMonBackPic_Darkrai_D[] = INCBIN_U32("graphics/pokemon/darkrai/distortion/back.4bpp.lz");
    const u32 gMonShinyPalette_Darkrai_D[] = INCBIN_U32("graphics/pokemon/darkrai/distortion/shiny.gbapal.lz");
    const u8 gMonFootprint_Darkrai_D[] = INCBIN_U8("graphics/pokemon/darkrai/distortion/footprint.1bpp");
    const u8 gMonIcon_Darkrai_D[] = INCBIN_U8("graphics/pokemon/darkrai/distortion/icon.4bpp");
