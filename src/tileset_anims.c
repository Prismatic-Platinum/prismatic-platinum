...
static void QueueAnimTiles_General_Water(u16 timer)
{
    ...
    AppendTilesetAnimToBuffer(gTilesetAnims_General_Water[i], (u16 *)(BG_VRAM + TILE_OFFSET_4BPP(458)), 2 * TILE_SIZE_4BPP);
    AppendTilesetAnimToBuffer(gTilesetAnims_General_Water[i], (u16 *)(BG_VRAM + TILE_OFFSET_4BPP(474)), 2 * TILE_SIZE_4BPP);
}
