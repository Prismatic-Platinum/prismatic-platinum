...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_SANDGEM_TOWN] = {MAP_GROUP(SANDGEM_TOWN), MAP_NUM(SANDGEM_TOWN), HEAL_LOCATION_PETALBURG_CITY},
    [MAPSEC_JUBILIFE_CITY] = {MAP_GROUP(JUBILIFE_CITY), MAP_NUM(JUBILIFE_CITY), HEAL_LOCATION_PETALBURG_CITY},
    ...
    [MAPSEC_ROUTE_202] = {MAP_GROUP(ROUTE202), MAP_NUM(ROUTE202), HEAL_LOCATION_NONE},
};
